...
process
	begin
		simEN <= '0';	simRESET <= '0';	simvgaTEST <= '0';	simvgaMODE <= "00";	simpixelDATA <= (others => '0');	wait for CLK_period * 2;
		simEN <= '1';	simRESET <= '1';	simvgaTEST <= '1';	simvgaMODE <= "00";	simpixelDATA <= (others => '0');	wait for CLK_period * 8000;
