...
#
# Generated by export_simulation on Tue May 02 10:00:52 +0200 2017
#
################################################################################
...
switch to the './analog_bd.sh' script.

./analog_bd.sh -reset_run
...
./analog_bd.sh -noclean_files

For more information on the script, please type './analog_bd.sh -help'.
